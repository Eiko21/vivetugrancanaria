...
@section('infosection')
    <div class="container">
        <div class="form_add_user">
            <h2>Modificar {{$activity->name}}</h2>
            <h5>*Campos obligatorios</h5>

            <form method="POST" action = "{{ url(route('updateactivity',$activity->id))  }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="Descripcion"><b>* Descripción</b></label>
                        <textarea class="form-control" id="description" name="description" rows="10" 
                            cols="40">{{ old('description')??$activity->description }}
                        </textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" name="duration" value="{{ old('duration')??$activity->duration }}" 
                        id="duration"  min="0" required>                    
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col text-center">
                            <button type="submit" name="store-activity" class="btn btn-primary">Actualizar</button>
                        </div>
                    </div>
                </div>
            </form>
